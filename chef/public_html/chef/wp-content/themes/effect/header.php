...
<div class="wrapper">
<div id="pronav" class="nav"> <?php if (of_get_option('effect_sharebut' ) =='1' ) {load_template(get_template_directory() . '/includes/social.php'); } ?>
...
<?php if (of_get_option( 'effect_logo' )): ?>
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo of_get_option( 'effect_logo' ); ?>" height="" width="" alt=""/></a>
      			<?php else : ?>        
            <h1 class="site-title">
...
<div id="navigation" class="nav"> 
	...
	<?php if ( (function_exists( 'of_get_option' )) && (of_get_option('slidetitle5',true) !=1) ) {
